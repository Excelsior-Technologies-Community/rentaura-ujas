        ...
        <div className="container mt-3">
          <div className="row content-section">
            <div className="col-md-6 content-box">
              ...
              <p>
                Discover the booming locations and rising stars in the Mexican
                property market. Find your investment or dream home destination.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="row justify-content-center">
            <div className="col-md-6">
              <div className="blog-card-one">
                ...
                <h5>
                  Rentership Ranks on the Rise: Canadian Cities With Highest
                  Shares of Renters
                </h5>
                <p className="text-muted" style={{ fontSize: "1.2rem" }}>
                  Rentership at an all-time high, no longer just a young
                  people’s game; Montréal leads in share of tenant households as
                  renting spreads across all generations.
                </p>
          ...
          <div className="row">
                ...
                <div className="col-md-6">
                  <div className="blog-card1">
                    ...
                    <a
                      ...
                      className="read-more1 text-success"
                    >
                      Read More{" "}
                      <i
                        className="fa-solid fa-chevron-right"
            ...
            <div className="col-md-4">
              ...
              <ul className="list-unstyled">
                ...
                <li className="d-flex justify-content-between py-3">
                  <span className="linkcolor">International Real Estate</span>{" "}
                  <span>09</span>
                </li>
                <li className="d-flex justify-content-between py-3">
                ...
                <li className="d-flex justify-content-between py-3">
                  <span className="linkcolor">Homebuying</span> <span>08</span>
                </li>
                <li className="d-flex justify-content-between py-3">
                  <span className="linkcolor">Renting</span> <span>02</span>
                </li>
                <li className="d-flex justify-content-between py-3">
                  <span className="linkcolor">Selling</span> <span>09</span>
                </li>
                <li className="d-flex justify-content-between py-3">
                ...
                <li className="d-flex justify-content-between py-3">
                  <span className="linkcolor">Life Style</span> <span>25</span>
                </li>
                <li className="d-flex justify-content-between py-3">
        ...
        <div className="container mt-5">
          ...
          <div className="row">
            <div className="col-md-7">
              <img src={A5} className="img-fluid news-image" alt="Home Image" />
            ...
            <div className="col-md-5">
              <div className="blog-card3">
                ...
                <h5>
                  Can You Negotiate Real Estate Agent Fees? 8 Things You Need to
                  Know First
                </h5>
              ...
              <div className="see-more-btn">
                <button className="btn1 btn-outline-dark">See More</button>
              </div>
            </div>
          </div>
          <hr style={{ marginTop: "50px" }} />
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <div className="blog-card6">
                    ...
                    <a
                      href="Singlepost.html"
                      className="read-more3 text-success"
                    >
                      Read More{" "}
                      <i
                        className="fa-solid fa-chevron-right"
          ...
          <div className="row">
            <div className="col-md-7">
              ...
              <div className="blog-card7">
                ...
                <a
                  href="Singlepost.html"
                  className="read-more4 text-success text-success"
                >
                  Read More{" "}
                  <i
                    className="fa-solid fa-chevron-right"
